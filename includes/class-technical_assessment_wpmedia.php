...
class Tawp_Technical_Assessment_Wpmedia {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Technical_assessment_wpmedia_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'TECHNICAL_ASSESSMENT_WPMEDIA_VERSION' ) ) {
			$this->version = TECHNICAL_ASSESSMENT_WPMEDIA_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'technical_assessment_wpmedia';
	 ...
	 *
	 * - Technical_assessment_wpmedia_Loader. Orchestrates the hooks of the plugin.
	 * - Technical_assessment_wpmedia_i18n. Defines internationalization functionality.
	 * - Technical_assessment_wpmedia_Admin. Defines all hooks for the admin area.
	 * - Technical_assessment_wpmedia_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Technical_assessment_wpmedia_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
